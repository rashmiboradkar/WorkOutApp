...
import kotlinx.android.synthetic.main.activity_normal_exercise.*
...
class NormalExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_normal_exercise)
        ...
        exerciseList = NormalExercises.defaultExerciseList()
        setupRestView()
        ...
        exerciseTimer = object : CountDownTimer(exerciseTime*1000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition < exerciseList?.size!! - 1){
                    ...
                    finish()
                    val intent = Intent(this@NormalExerciseActivity, FinishActivity::class.java)
